...
% -------------- README --------------
% - All text to be printed is to be placed between curly braces {} (This helps in escaping special characters)
% - two backslashes (\\) represent new line (Notice that the last item in a list does not end with a new line)
